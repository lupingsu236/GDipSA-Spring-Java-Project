...
public class Sa51JavaCaApplication {
	...
	CommandLineRunner runner() {
		return args ->{
			...
			Product p1=new Product("BP7440LL","Part description: T-6 bulb 3/4 dia; Color: clear; light center length(ln.): 1.250; Design volts primary: 12; Design watts primary: 21; Design amps primary: 1.75.","Lighting and signaling system","Light", "Brake light", 13.08, 100,100,150);
			Product p2=new Product("D3S","Part description: T-3 bulb 3/8 dia; Color: clear; Design volts primary: 42; Design watts primary: 35; Design amps primary: 0.83.","Lighting and signaling system","Light", "Headlight", 14.9, 120,50,100);
			Product p3=new Product("BPH11TVX","Color: clear; Filament quantity: 1; Design volts primary: 12; Design watts primary: 55; Design amps primary: 4.58; Related avg. life hours primary: 300.","Lighting and signaling system","Light", "Fog light", 15.02, 100,50,500);
			Product p4=new Product("BPH11ND2","Part description: T-4 bulb 37/64 dia; Color: clear; Filament quantity: 1; Design volts primary: 12; Design watts primary: 55; Design amps primary: 4.58.","Lighting and signaling system","Light", "Brake light", 13.81, 100,50,500);
			Product p5=new Product("BP168LL","Part description: T-3 bulb 13/32 dia; Color: clear; Filament quantity: 1; Design volts primary: 14; Design watts primary: 4.9; Design amps primary: 0.35; Related avg. life hours primary: 1500.","Lighting and signaling system","Light", "Tail light", 9.75, 100,75,500);
			...
			Product p6=new Product("FP-1650CP","2.3 L(138.0) L4 wheel tractor engines; 8 valve 3.375 bore carb 1 bbl. gasoline naturally aspirated G138;","Generator","Engine", "Jet engine", 133.3, 50,50,500);
			Product p7=new Product("FP-2520CP10","2.4 L(149.0) L4 OHV crawler tractor engine; 8 valve 2.5000 bore carb 1 bbl. gasoline naturally aspirated G149;","Generator","Engine", "Jet engine", 124.6, 50,50,500);
			Product p8=new Product("FP-AX1650P","1.9 L(116.0) L4 OHV harvest engine; 8 valve 3.2500 bore carb 1 bbl. gasoline naturally aspirated B15;","Generator","Engine", "Jet engine", 138.2, 50,50,500);
			Product p9=new Product("OS 12237","3.3 L(200.0) L4 OHV crawler tractor engine; 8 valve 3.8750 bore FI MFI diesel naturally aspirated D2200;","Generator","Engine", "Piston engine", 158.7, 50,50,500);
			Product p10=new Product("HS 7805 B-2","4.4 L(262.0) L6 OHV crawler tractor engine; 12 valve 3.5625 bore FI MFI diesel naturally aspirated D262;","Generator","Engine", "Piston engine", 181.2, 50,50,500);
			...
			Product p11=new Product("48/L3 Group/H6-AGM","Weight: 45.6 kg; Voltage: 12 Volt; PHCA: 1140; Reserve capacity 25Amp draw: 137 min; Chemistry: thin plate, pure lead AGM.","Low voltage electrical supply system","Battery", "Dual purpose battery", 283.99, 100,100,300);
			Product p12=new Product("FT16V830-24,","Weight: 59.3 kg; Voltage: 16 Volt; PHCA: 1140; Reserve capacity 25Amp draw: 120 min; Chemistry: sealed lead acid AGM.","Low voltage electrical supply system","Battery", "Dual purpose battery", 347.32, 100,100,300);
			Product p13=new Product("DC55-12","Weight: 38.3 kg; Voltage: 12 Volt; Reserve capacity 25Amp draw: 96 min; Chemistry: sealed lead acid AGM.","Electrical","Low voltage electrical supply system", "Fullriver battery", 266.49, 100,100,300);
			Product p14=new Product("DC35-12","Weight: 25.4 kg; Voltage: 12 Volt; Reserve capacity 25Amp draw: 52 min; Chemistry: sealed lead acid AGM.","Electrical","Low voltage electrical supply system", "Fullriver battery", 210.49, 100,100,300);
			Product p15=new Product("48-723CCA","Weight: 48 kg; Voltage: 12 Volt; PHCA: 1250; Reserve capacity 25Amp draw: 130 min; Chemistry: thin plate, pure lead AGM.","Low voltage electrical supply system","Battery", "Starting battery", 259.99, 100,100,300);
			...
			Product p16=new Product("A4TR5591ZT","Voltage: 24 V; Amp.: 110 A; G: 8 qty.; L.1: 212 mm.","Low voltage electrical supply system","Alternator", "Automotive alternator", 80.4, 100,50,300);
			Product p17=new Product("UD19236A","Voltage: 24 V; Amp.: 110 A; G: 6 qty.; L.1: 218 mm.","Low voltage electrical supply system","Alternator", "Radio alternator", 76.9, 100,50,300);
			Product p18=new Product("CAL35619RS","Voltage: 24 V; Amp.: 110 A; G: 10 qty.; L.1: 213 mm.","Low voltage electrical supply system","Alternator", "Brushless alternator", 100.6, 100,50,300);
			...
			Product p19=new Product("63528BZD","Core size: 610 mm*368 mm* 26 mm; Color: silver; Working pressure: 1.0 Mpa.","Cooling system","Radiator", "Aluminum radiator", 58.3, 100,200,200);
			Product p20=new Product("AP-34888","Core size: 635 mm*320 mm* 30 mm; Color: black; Working pressure: 1.0 Mpa.","Cooling system","Radiator", "Aluminum radiator", 47.8, 100,200,200);
			Product p21=new Product("HB45999I","Core size: 590 mm*432 mm* 40 mm; Color: white; Working pressure: 1.0 Mpa.","Cooling system","Radiator", "Steel radiator", 79.2, 100,200,200);
